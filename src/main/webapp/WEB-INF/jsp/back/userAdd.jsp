		...
		<div class="page-content">
			<div class="col-xs-12">
				<form id="f_form" class="form-horizontal" method="post">
					...
					<div class="form-group">
						<label for="username" class="col-sm-3 control-label no-padding-right">电话：</label>
						<div class="col-sm-9">
							<input type="text" class="col-xs-10 col-sm-3" id="phone" name="phone" value="${user.phone}">
						</div>
					</div>
					<div class="form-group">
						<label for="username" class="col-sm-3 control-label no-padding-right">地址：</label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" class="col-xs-10 col-sm-3" id="password" name="password" value="${user.password}">
						</div>
					</div>
					<div class="clearfix">
