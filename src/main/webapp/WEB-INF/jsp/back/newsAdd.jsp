...
<html>
	...
	<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/lastHouse/WebRoot/WEB-INF/jsp/back/newsAdd.jsp">

		<div class="breadcrumbs" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/lastHouse/WebRoot/WEB-INF/jsp/back/newsAdd.jsp">
			<ul class="breadcrumb">
				<li>
		...
		<div class="container">
			 <form action="<%=basePath%>back/news/save" method="post">
			     ...
			     <textarea id="cont" name="contents" style="min-height: 700px"></textarea>
			     <br/>
